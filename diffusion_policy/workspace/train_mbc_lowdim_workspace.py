...
from diffusion_policy.policy.mbc_lowdim_policy import MBCLowdimPolicy
...
# %%
class TrainMBCLowdimWorkspace(BaseWorkspace):
    ...
    def run(self):
        ...
        with JsonLogger(log_path) as json_logger:
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                # run action sampling on a training batch
...
def main(cfg):
    workspace = TrainMBCLowdimWorkspace(cfg)
    workspace.run()
