...
from diffusion_policy.policy.diffusion_unet_lowdim_sa_policy import DiffusionUnetLowdimSAPolicy
...
# %%
class TrainDiffusionUnetLowdimSAWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetLowdimSAPolicy
        self.model = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetLowdimSAPolicy = None
...
def main(cfg):
    workspace = TrainDiffusionUnetLowdimSAWorkspace(cfg)
    workspace.run()
